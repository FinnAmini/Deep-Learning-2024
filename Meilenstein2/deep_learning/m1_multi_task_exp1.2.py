...
# Custom loss function for age prediction
...
# Custom loss function for gender prediction
@register_keras_serializable()
...
# Custom metric for age prediction
@register_keras_serializable()
...
# Custom metric for gender prediction
@register_keras_serializable()
...
if __name__ == "__main__":
    ...
    for batch_size in batch_sizes:
        ...
        # Loop over each top layer configuration
